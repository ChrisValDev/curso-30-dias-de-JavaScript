...
const promesa = new Promise((resolve, reject) => {
    setTimeout(() => {
        resolve(console.log("Hola mundo en una promesa"))
    }, 5000);
});
...
// Por ejemplo, supongamos que queremos imprimir un mensaje cada 4 segundos. Podemos usar setInterval de la siguiente manera:

setInterval(() => {
    console.log("Aparezco cada 4 segundos hasta que me detengan");
}, 4000);

// Esto imprimirá "Aparezco cada 4 segundos hasta que me detengan" cada 4 segundos.
...
wait(-5000)
    ...
    .catch((error) => {
        console.log(error.message);
                // El numero de milisegundos no puede ser negativo
    });
