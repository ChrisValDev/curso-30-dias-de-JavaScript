...
// Book hereda las propiedades y los metodos de la clase Product
class Book extends Product {
    constructor(name, price, description, author, editorial) {
        // Recuerda que con Super le pasamos los atributos a la clase de la cual se hereda
        super(name, price, description);
        // A continuacion se definen las propiedades originales de esta clase Book
        this.author = author;
    ...
    show() {
        super.show();
        // Redefine el metodo show() de la clase Product para mostrar la siguiente informacion.
...
const libro = new Book("Habitos atomicos", 399, "Superacion Personal", "James Clear", "PAIDOS");
libro.show();